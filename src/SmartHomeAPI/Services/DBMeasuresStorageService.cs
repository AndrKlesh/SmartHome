...
/// Сервис измерений
/// </summary>
public sealed class DBMeasuresStorageService (IServiceProvider serviceProvider,
										   SubscriptionRepository subscriptionRepository,
										   MeasuresLinksRepository measuresLinksRepository,
										   ILogger<DBMeasuresStorageService> logger) : IDisposable, IMeasuresStorageService
{
	...
	public async Task AddMeasureAsync (MeasureDTO measurementDto)
	{
		...
		try
		{
			...
			DBMeasuresRepository measurementRepository = scope.ServiceProvider.GetRequiredService<DBMeasuresRepository>();
